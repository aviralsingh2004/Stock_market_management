...
const companies = [
    'AAPL', 'MSFT', 'GOOGL', 'AMZN', 'TSLA', 'META', 'NFLX', 'NVDA', 'BRK.A', 'JPM',
    'V', 'UNH', 'HD', 'PG', 'DIS', 'MA', 'PYPL', 'ADBE', 'PFE', 'CSCO',
    'INTC', 'PEP', 'KO', 'CMCSA', 'ABT', 'CVX', 'T', 'MRK', 'WMT', 'NKE',
    'XOM', 'LLY', 'ORCL', 'BAC', 'COST', 'MCD', 'PM', 'CRM', 'IBM', 'ACN',
    'AMD', 'AVGO', 'TXN', 'QCOM', 'TMO', 'UPS', 'UNP', 'LIN', 'SBUX', 'MDT',
    'CAT', 'HON', 'NEE', 'GS', 'RTX', 'SPGI', 'NOW', 'BLK', 'CHTR', 'AMAT',
    'DHR', 'INTU', 'AMGN', 'ADP', 'DE', 'LOW', 'PLD', 'MS', 'ZTS', 'BA',
    'AXP', 'LMT', 'BMY', 'ISRG', 'CI', 'BKNG', 'GE', 'FIS', 'MO', 'SCHW',
    'TJX', 'GILD', 'CVS', 'TGT', 'F', 'MMM', 'C', 'DUK', 'ATVI', 'ADSK',
    'AEP', 'WM', 'ECL', 'EW', 'CL', 'AON', 'APD', 'COP', 'CCI', 'REGN',
];
...
async function insertData(stockData) {
    try {
        ...
        console.error(`Error inserting data for ${stockData.symbol}:`, error.message);
    }
}
